...
class Asteroid(circleshape.CircleShape):
    ...
    def rotate(self, angle):
        self.rotation += self.velocity.rotate(angle)
    ...
    def split(self):
        ...
        vector_left = self.rotate(-angle)
        vector_left = pygame.math.Vector2.scale_to_length(vector_left, new_velocity)
        vector_right = self.rotate(angle)
        vector_left = pygame.math.Vector2.scale_to_length(vector_left, new_velocity)
